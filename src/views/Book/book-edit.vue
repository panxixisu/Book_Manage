      ...
      <el-row :gutter="30">
        <el-col :span="12">
          <div class="grid-content">
            ...
            <el-form-item label="BookID" style="text-align: left" prop="bookId">
              {{ dataForm.bookId }}
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12" class="row-bg">
          <div class="grid-content">
            <el-form-item label="封面" prop="imgName">
              ...
              >
                <img :src="'http://www.panxixi.xyz/web/upload/' + imgUrl" class="avatar" />
              </el-upload>
            </el-form-item>
     
            <el-form-item label="评分" prop="bookScore">
              <el-rate
                style="height: 32px; line-height: 32px; padding-top: 5px"
                v-model="dataForm.bookScore"
                :max="10"
                :allow-half="true"
              >
              </el-rate>
            ...
            <el-form-item label="字数" prop="Words">
              <el-input v-model.number="dataForm.Words" style="width: 150px"
      ...
      <el-row :gutter="30">
        <el-col :span="24">
          <div class="grid-content-bottom">
            ...
            <el-form-item>
              <el-button type="primary" @click="ModifyForm('dataForm')"
                >确定修改</el-button
              >
...
export default {
  ...
  computed: {
    ...
    imgUrl: function () {
      return this.$store.state.editData[0].imgName;
    },
    // geturl(){
  ...
  methods: {
    ...
    ModifyForm(dataForm) {
      this.$refs[dataForm].validate((valid) => {
        if (valid) {
          this.$http
            .post("web/php/editBook.php", this.dataForm)
            .then((res) => {
    ...
    upload(param) {
      ...
      // this.$store.state.imgdata = formData
